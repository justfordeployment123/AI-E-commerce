  ...
  const load = async () => {
    ...
    try {
      ...
      const filteredCats = cats.filter((c) =>
        MAIN_CATEGORIES_SLUGS.has(c.slug.toLowerCase())
      );
  ...
  return (
    <div className="min-h-screen bg-background p-6 lg:p-8 max-w-6xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-extrabold text-zinc-900 tracking-tight">Brand–Category Links</h1>
        <p className="text-xs text-zinc-400 font-medium mt-1">
          Manage product presentation images associated with specific brand/category combinations.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="md:col-span-3 space-y-6">
          {activeCategory ? (
            ...
            <div className="bg-white border border-zinc-100 rounded-3xl p-12 text-center text-zinc-400 font-bold shadow-sm">
              Please create a category to get started.
            </div>
          )}
        </div>
      </div>
