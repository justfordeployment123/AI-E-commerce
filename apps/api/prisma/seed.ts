...
const TRADE_IN_SEED: { name: string; brand: string; category: string }[] = [
    ...
    { name: "PS3 Slim",                brand: "Sony PlayStation", category: "Console" },
    ...
    { name: "Xbox One",                brand: "Microsoft Xbox",  category: "Console" },
    { name: "Xbox 360 S",              brand: "Microsoft Xbox",  category: "Console" },
