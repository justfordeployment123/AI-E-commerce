      ...
      >
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center ml-1">
              ...
              <a href="#" className="text-[10px] font-bold text-zinc-400 hover:text-black transition-colors uppercase tracking-widest">Forgot?</a>
            </div>
            <div className="relative group">
              <input 
                type="password" 
        ...
        <div className="relative my-16">
          ...
          <div className="relative flex justify-center text-[10px] uppercase font-bold tracking-[0.3em]">
            <span className="bg-white px-6 text-zinc-300">Or use social</span>
          </div>
        </div>
        ...
        <p className="text-center text-sm text-zinc-500 mt-16 font-medium">
          New to TechStop? <a href="/signup" className="text-black font-bold border-b-2 border-accent pb-0.5 hover:border-black transition-all">Create an account</a>
        </p>
      </motion.div>
