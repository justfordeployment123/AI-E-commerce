    ...
    <div className="flex min-h-screen flex-col bg-white text-black font-sans">
      ...
      <header className="sticky top-0 z-50 border-b border-zinc-100 bg-white/80 backdrop-blur-md">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <nav className="flex items-center gap-6 text-sm font-medium">
            ...
            <a href="#" className="hover:text-zinc-600">Log in</a>
      ...
      <main className="flex-1">
        ...
        <section className="mx-auto grid max-w-7xl gap-4 px-4 py-8 sm:grid-cols-3 sm:px-6 lg:px-8">
          {[
            { title: "12-month warranty", text: "Every device is covered for a full year.", icon: "🛡️" },
            { title: "30-day returns", text: "Not satisfied? Send it back for free.", icon: "🔄" },
            { title: "Expert certification", text: "25+ quality checks by professionals.", icon: "✅" },
          ].map((item) => (
        ...
        <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
          <div className="mb-8 flex items-end justify-between">
            ...
            <a href="#" className="font-bold underline decoration-accent decoration-4 underline-offset-8">
              View all
            </a>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-12 md:grid-cols-4">
            <div className="col-span-2">
              ...
              <p className="mt-6 max-w-sm text-zinc-600">
              ...
              <div className="mt-6 flex max-w-sm gap-2">
                <input
                  ...
                  className="h-12 flex-1 rounded-2xl bg-zinc-100 px-4 text-sm outline-none focus:ring-2 focus:ring-accent"
                />
                <button className="rounded-2xl bg-black px-6 text-sm font-bold text-white">Join</button>
              </div>
            </div>
            <div>
          ...
          <div className="mt-16 border-t border-zinc-100 pt-8 flex flex-wrap items-center justify-between gap-4 text-xs text-zinc-400 font-medium">
            <p>© 2026 Markhor Market. All rights reserved.</p>
            <div className="flex gap-6">
              <a href="#" className="hover:text-black uppercase tracking-widest">Privacy Policy</a>
              <a href="#" className="hover:text-black uppercase tracking-widest">Terms of Service</a>
              <a href="#" className="hover:text-black uppercase tracking-widest">Cookie Policy</a>
            </div>
          </div>
        </div>
      </footer>
