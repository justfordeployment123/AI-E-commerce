            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
                ...
                >
                  <div className="relative group">
                    <input 
                      ...
                      className="w-full h-20 rounded-[1.5rem] bg-white border-2 border-transparent focus:border-black px-8 text-lg outline-none transition-all shadow-xl"
                    />
              ...
              >
                <div className="relative aspect-square w-full max-w-md mx-auto">
                   <div className="absolute inset-0 bg-white rounded-[4rem] rotate-6 shadow-2xl" />
                   <div className="relative h-full w-full p-12 flex flex-col justify-center items-center text-center">
                      <div className="h-24 w-24 bg-accent rounded-3xl flex items-center justify-center mb-8 rotate-12">
                        <DollarSign className="h-12 w-12" />
                      </div>
                      <h4 className="text-2xl font-serif font-medium mb-4">Paid to sellers</h4>
                      <p className="text-5xl font-bold tracking-tighter">$1.2M+</p>
                  ...
                  <div className="space-y-8">
                     {[
                       ...
                       <div key={i} className="flex gap-6 group">
                          <div className="h-14 w-14 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center flex-shrink-0 group-hover:bg-accent group-hover:text-black transition-all">
               ...
               <div className="relative">
                  <div className="aspect-square rounded-[4rem] bg-accent/10 border border-white/5 p-12 relative overflow-hidden">
                     ...
                     <div className="relative z-10 h-full flex flex-col justify-center">
                        <div className="bg-white text-black p-8 rounded-[2.5rem] shadow-2xl rotate-3">
                           ...
                           <p className="text-4xl font-serif font-medium mb-2">$429.00</p>
