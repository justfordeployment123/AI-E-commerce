              ...
              <div className="flex gap-3 overflow-x-auto scrollbar-hide">
                {PRODUCT.images.map((img, i) => (
                  <button
                    ...
                    className={`h-20 w-20 shrink-0 rounded-2xl overflow-hidden border-2 transition-all ${activeImage === i ? "border-black" : "border-transparent"}`}
                  >
            ...
            <div>
              ...
              <div className="flex gap-3 mb-6">
                <motion.button
                  ...
                  className={`flex-1 h-16 rounded-3xl font-bold text-base flex items-center justify-center gap-2 transition-all ${
                ...
                <motion.button
                  whileTap={{ scale: 0.98 }}
                  className="h-16 w-16 rounded-3xl border-2 border-zinc-200 flex items-center justify-center hover:border-black transition-colors"
                >
              ...
              <div className="grid grid-cols-3 gap-3 mb-8">
                {[
                  ...
                  <div key={text} className="flex flex-col items-center gap-2 rounded-3xl bg-zinc-50 p-4 text-center">
              ...
              {/* In the box */}
              <div className="rounded-3xl bg-zinc-50 p-5 mb-6">
                  ...
                  <div className="space-y-3">
                    {Object.entries(GRADE_DESC).map(([grade, desc]) => (
                      <div key={grade} className="flex items-start gap-3">
                        <span className={`rounded-full px-3 py-1 text-[10px] font-bold uppercase tracking-widest shrink-0 mt-0.5 ${GRADE_COLORS[grade]}`}>{grade}</span>
                        ...
                        {[5,4,3,2,1].map(n => (
                          <div key={n} className="flex items-center gap-3">
                            ...
                            <div className="flex-1 h-2 bg-zinc-100 rounded-full overflow-hidden">
                              <div className="h-full bg-accent rounded-full" style={{ width: `${n === 5 ? 78 : n === 4 ? 14 : n === 3 ? 5 : n === 2 ? 2 : 1}%` }} />
                            </div>
                          </div>
                        ))}
                      </div>
